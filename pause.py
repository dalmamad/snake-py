...
Pause.options.append(Pause(0,'Resume',PAUSE_OPCOLOR,PAUSE_SELECT_COLOR,PAUSE_TXTCOLOR,PAUSE_OPLEN,PAUSE_OPPOS, PAUSE_OPGAP))
Pause.options.append(Pause(1,'menu',PAUSE_OPCOLOR,PAUSE_SELECT_COLOR,PAUSE_TXTCOLOR,PAUSE_OPLEN,PAUSE_OPPOS, PAUSE_OPGAP))

def pause_game():

    Pause.pause = True
    Pause.selector = 0
    # Pause.surface.fill(PAUSE_BGCOLOR)
    Pause.draw_frame()
    ...
    while Pause.pause:
        ...
        for option in Pause.options:
            option.draw()
            option.txtdraw()
        # screen.blit(pause_surf,PAUSE_POS)
